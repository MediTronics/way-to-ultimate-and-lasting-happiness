= Behavioural Changes Leading to Peace and Happiness
...
Our behaviours that effect society are mainly speech based (like lying, harsh speech, divisive speech, idle chatter) and action based. Further both speech and action based 
